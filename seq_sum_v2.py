...
class Encoder(nn.Module):
    ...
    def forward(self, src, src_mask):
        ...
        import pdb;pdb.set_trace
        print("Entering Encoder forward part")
...
class MultiHeadAttentionLayer(nn.Module):
    ...
    def forward(self, values, keys, query, mask):
        ...
        print(f'values shape is values.shape {values.shape}')
...
if __name__ == "__main__":
    ...
    ipdb> c
Entering Encoder part
Entering Encoder Layer  part
Entering Encoder Layer  part
Entering Encoder Layer  part
> /content/trans-vsumm/seq_sum.py(410)forward()
-> src = torch.tensor(src).to(self.device).long()
(Pdb) c
seq_sum.py:410: UserWarning: To copy construct from a tensor, it is recommended to use sourceTensor.clone().detach() or sourceTensor.clone().detach().requires_grad_(True), rather than torch.tensor(sourceTensor).
  src = torch.tensor(src).to(self.device).long()
> /content/trans-vsumm/seq_sum.py(370)make_src_mask()
-> print("Entering Source mask")
(Pdb) c
Entering Source mask
Entering Encoder forward part
Entering Encoder Layer forward part
********************************************
