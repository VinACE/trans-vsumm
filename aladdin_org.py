"""
https://www.youtube.com/watch?v=U0s0f995w14 alddin persson
...
if __name__ == "__main__":
    ...
    x = torch.tensor([[1, 5, 6, 4, 3, 9, 5, 2, 0], [1, 8, 7, 3, 4, 5, 6, 7, 2]], dtype=torch.int64).to(
        device
    )
    trg =  torch.tensor([[1, 7, 4, 3, 5, 9, 2, 0], [1, 5, 6, 2, 4, 7, 6, 2]], dtype=torch.int64).to(device)
